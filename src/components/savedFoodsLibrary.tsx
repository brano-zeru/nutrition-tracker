    ...
    return (
        <Sheet>
            <SheetTrigger asChild>
                <Button
                    variant="outline"
                    className="gap-1.5 sm:gap-2 border-border/50 text-xs sm:text-sm h-8 sm:h-9 px-2 sm:px-4"
                >
            ...
            <SheetContent className="w-full sm:max-w-md bg-card border-border p-0">
                <SheetHeader className="p-4 sm:p-6 pb-3 sm:pb-4">
                    ...
                    <SheetDescription>
                        Search and add foods from your saved library to
                        today&apos;s log.
                    </SheetDescription>
                </SheetHeader>
                    ...
                    <div className="flex gap-2">
                        ...
                        <Dialog open={isAddOpen} onOpenChange={setIsAddOpen}>
                            <DialogTrigger asChild>
                                <Button
                                    size="icon"
                                    className="bg-primary text-primary-foreground shrink-0 h-9 w-9 sm:h-10 sm:w-10"
                                >
                            ...
                            <DialogContent className="bg-card border-border max-w-[calc(100%-2rem)] sm:max-w-md">
                                <DialogHeader>
                                    ...
                                    <DialogDescription>
                                        Save a new food to your library for
                                        quick access.
                                    </DialogDescription>
                                </DialogHeader>
                ...
                >
                    <DialogContent className="bg-card border-border max-w-[calc(100%-2rem)] sm:max-w-md">
                        <DialogHeader>
                            ...
                            <DialogDescription>
                                Specify the amount in grams to add to
                                today&apos;s log.
                            </DialogDescription>
                        </DialogHeader>
                        <FieldGroup className="gap-3 sm:gap-4">
