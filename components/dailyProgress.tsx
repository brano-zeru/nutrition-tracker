  ...
  return (
    <Card className="border-border/50 bg-card">
      <CardHeader className="pb-3 sm:pb-4 px-3 sm:px-6">
        <CardTitle className="text-base sm:text-lg font-medium">Daily Progress</CardTitle>
      </CardHeader>
      <CardContent className="px-3 sm:px-6">
          ...
          <div className="flex flex-col items-center">
            ...
            >
              <div className="flex flex-col items-center">
                ...
                <span className="text-lg font-bold">{Math.round(protein)}g</span>
                <span className="text-[10px] text-muted-foreground">
                  / {goals.proteinGoal}g
                </span>
              </div>
        ...
        <div className="mt-4 sm:mt-6 pt-4 sm:pt-6 border-t border-border/50 grid grid-cols-2 gap-3 sm:gap-4">
          <div className="bg-secondary/50 rounded-lg p-3 sm:p-4">
            <p className="text-[10px] sm:text-xs text-muted-foreground uppercase tracking-wide">Remaining</p>
